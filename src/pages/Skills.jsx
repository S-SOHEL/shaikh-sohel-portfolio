...
const ROWS = [
  [
    ...
    },
    {
      ...
      items: ["Node.js", "Express.js", "MongoDB", "MySQL", "SQL Basics"],
    },
    {
      title: "Tools & Platforms",
      items: ["Git & GitHub", "WordPress", "VS Code", "REST APIs"],
    },
  ],
  [
    {
    ...
    <section className="skills-container" id="skills">
      ...
      >
        ...
        <p className="text-gray-400 text-lg max-w-xl mx-auto">
          💻 Full Stack MERN skills combined with strong fundamentals in Java, Python, SQL and modern web development.
        </p>
      </motion.div>
